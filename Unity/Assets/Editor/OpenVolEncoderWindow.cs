...
/// </summary>
public sealed class OpenVolEncoderWindow : EditorWindow
{
    private const string PreferencePrefix = "OpenVol.Encoder.";
    private const string AuthoringLibrary = "OpenVolAuthoring";

    [DllImport(
        AuthoringLibrary,
        EntryPoint = "openvol_authoring_pack",
    ...
    [DllImport(
        AuthoringLibrary,
        EntryPoint = "openvol_authoring_encode_obj",
        CallingConvention = CallingConvention.Cdecl)]
    ...
    [DllImport(
        AuthoringLibrary,
        EntryPoint = "openvol_authoring_last_error",
        CallingConvention = CallingConvention.Cdecl)]
    ...
    {
        OpenVolEncoderWindow window =
            GetWindow<OpenVolEncoderWindow>("OpenVol Encoder");
    ...
    private void OnGUI()
    {
        ...
        EditorGUILayout.LabelField("OpenVol Encoder", EditorStyles.boldLabel);
    ...
    private void Encode(EncodingInputs inputs, CancellationToken token)
    {
        ...
        try
        {
            ...
            try
            {
                AppendLog("Calling the native OpenVolAuthoring library.");
