...
public:
	...
	openvolumetric::FrameMatchResult get_video_data(
...
protected:
	...
	bool route_packet(openvolumetric::ContainerPacket packet);
	/// Converts one owning container packet into an AVPacket and decodes it.
	bool decode_packet(const openvolumetric::ContainerPacket& packet);
